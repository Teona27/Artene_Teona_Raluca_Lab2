...
namespace Artene_Teona_Raluca_Lab2.Data
{
    public class Artene_Teona_Raluca_Lab2Context : DbContext
    {
        ...
        public DbSet<Artene_Teona_Raluca_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Artene_Teona_Raluca_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
